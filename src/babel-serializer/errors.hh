...
using error_handler = cc::function_ref<void(cc::span<std::byte const> data, cc::span<std::byte const> pos, char const* message, severity)>;
...
void default_error_handler(cc::span<std::byte const> data, cc::span<std::byte const> pos, char const* message, severity s);
}
